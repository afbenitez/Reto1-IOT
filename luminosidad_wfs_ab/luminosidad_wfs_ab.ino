...
void loop()
{
  ...
  //Lectura los datos del sensor de luminosidad
  int val=analogRead(lightsensor);
  String msg="fuerza de la luz en tiempo real";
  msg= msg+ val;
  //compara el valor optenido por la definición del estado a evaluar 
   if (val>threhold)
      msg="0: "+msg;
    else
      msg="1: "+msg;
  //Transforma la información a la notación JSON para poder enviar los datos 
  //El mensaje que se envía es de la forma {"value": x}, donde x es el valor de temperatura, humedad o luminosidad
